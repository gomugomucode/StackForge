...
export const cheatsheets: Cheatsheet[] = [
  {
    ...
    level: 'Beginner',
    thumbnail: 'https://images.unsplash.com/photo-1579546678193-536fe273f4dC?w=800&fm=webp&q=80',
    tags: ['JS', 'ES6', 'Web'],
  ...
  },
  {
    ...
    category: 'Web Development',
    level: 'Intermediate',
    thumbnail: 'https://images.unsplash.com/photo-1633356122544-27a6efa04f4b?w=800&fm=webp&q=80',
    tags: ['React', 'Hooks', 'UI'],
