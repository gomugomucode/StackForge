    ...
    quizQuestions: [
      {
        ...
        options: [
          ...
          'An in-memory representation of the UI that React compares before updating the real DOM',
          'A CSS framework for virtual scrolling',
          'A server-side rendering engine',
        ],
        correctIndex: 1,
        explanation: 'React maintains a lightweight virtual tree in memory. Diffing this tree against the previous version determines minimal real DOM updates.',
      },
      {
        id: 'react-vdom-q2',
        question: 'What happens when you call setCount(count + 1) in a functional component?',
        options: [
          'The DOM updates immediately and synchronously',
          'React schedules a re-render with the new state value',
          'The variable count is mutated in place',
          'Nothing until the component unmounts',
        ],
        correctIndex: 1,
        explanation: 'State setters queue an update. React batches updates and re-renders the component with the new state.',
      },
      {
        id: 'react-vdom-q3',
        ...
        options: [
          ...
          'React cannot detect the change and will not re-render',
          'It only works in class components',
          'It improves performance',
        ],
        correctIndex: 1,
        explanation: 'React relies on referential equality checks. Mutating state in place bypasses change detection.',
      },
      {
        id: 'react-vdom-q4',
        question: 'What is reconciliation in React?',
        options: [
          'Merging two React apps into one',
          'The process of comparing virtual DOM trees and applying minimal updates to the real DOM',
          'Combining Redux and Context API',
          'Error recovery after a crash',
        ],
        correctIndex: 1,
        explanation: 'Reconciliation is React\'s diffing algorithm that determines the most efficient way to update the browser DOM.',
      },
    ],
  },
  {
    ...
    quizQuestions: [
      {
        ...
        correctIndex: 1,
        explanation: 'useMemo caches the result of an expensive computation and returns it unless a dependency changes.',
      },
      {
        id: 'react-memo-q2',
        question: 'When should you use useCallback?',
        options: [
          'To memoize any variable',
          'To preserve a stable function reference across re-renders',
          'To replace useState entirely',
          'Only in class components',
        ],
        correctIndex: 1,
        explanation: 'useCallback returns a memoized callback, useful when passing functions to React.memo-wrapped child components.',
      },
      {
        id: 'react-memo-q3',
        question: 'What is a common pitfall with useMemo and useCallback?',
        options: [
          'They cannot be used with TypeScript',
          'Overusing them when the computation is cheap adds unnecessary complexity',
          'They always improve performance regardless of use case',
          'They prevent all re-renders globally',
        ],
        correctIndex: 1,
        explanation: 'Premature optimization with these hooks adds overhead. Use them when profiling shows a real benefit.',
      },
    ],
  },
]
