    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center">
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-wider mb-8"
        >
        ...
        >
          <Button size="lg" className="h-12 px-8 gap-2 group font-semibold shadow-md" asChild>
            <Link href="/roadmaps">
              <span>Get Started</span> <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
          </Button>
          <Button variant="outline" size="lg" className="h-12 px-8 gap-2 font-semibold" asChild>
            <Link href="/roadmaps">
