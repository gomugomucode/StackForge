    ...
    <>
      ...
      <header className="fixed top-0 z-50 w-full transition-all duration-300">
        <nav className="container mx-auto px-4 sm:px-6 lg:px-8 pt-4">
          <div className="flex items-center justify-between h-16 backdrop-blur-xl bg-card/80 text-card-foreground border border-border rounded-2xl px-4 shadow-sm transition-all duration-300">
            {/* Logo */}
            <Link href="/" className="flex items-center gap-2 group" aria-label={`${brandName} home`}>
              <div className="w-9 h-9 rounded-xl bg-primary text-primary-foreground flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-md">
